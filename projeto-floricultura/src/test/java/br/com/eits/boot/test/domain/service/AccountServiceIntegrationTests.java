...
/**
 * se selecionar um metodo 
 * ele vai e clicar em run as, 
 * vai só executar o metodo
 * 
 * se clicar em qualquer lugar da classe, vai executar todos os testes
 * 
 */
/**
 * 
...
public class AccountServiceIntegrationTests extends AbstractIntegrationTests
{
	...
	{
		User user = new User( null, "Testing user", "testss@user.com", true, UserRole.USER, "user" );
